...
var ToastContainer = function (_Component) {
  ...
  function ToastContainer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ToastContainer.__proto__ || Object.getPrototypeOf(ToastContainer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      toastId: 0,
      messageList: []
    }, _this.toastRefs = {}, _this._handle_toast_remove = _this._handle_toast_remove.bind(_this), _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(ToastContainer, [{
    ...
    value: function clear() {
      ...
      Object.keys(this.toastRefs).forEach(function (key) {
        _this2.toastRefs[key].hideToast(false);
      });
    }
  }, {
    key: "_notify",
      ...
      var newToast = (0, _reactAddonsUpdate2.default)(optionsOverride, {
        $merge: {
          ...
          ref: function ref(toast) {
            if (toast !== null) _this3.toastRefs["toasts__" + key] = toast;
          },
